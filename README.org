...
* DONE Examples
** DONE Functional sequence inspection (=GE MR750=)
*** Session overview
**** Raw data

     - [[https://raw.githubusercontent.com/nikadon/cc-dcm2bids-wrapper/master/examples/dicom---sub-human---6vols.tar.gz][dicom---sub-human---6vols.tar.gz]]
     - [[https://raw.githubusercontent.com/nikadon/cc-dcm2bids-wrapper/master/examples/dicom---sub-human---pepolarity.tar.gz][dicom---sub-human---pepolarity.tar.gz]]
